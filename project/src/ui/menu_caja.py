...
# Configuración de rutas para importaciones desde la raíz del proyecto
...
class MostrarMenuCaja:
    """
    Clase de interfaz de usuario para la gestión de caja.
    """
    ...
    def ejecutar_interfaz_caja(self):
        ...
        while True:
            ...
            # Instancia el selector pasando las dependencias inyectadas
    ...
    def _opciones_menu_caja():
        """Imprime las acciones disponibles (Venta, Reporte, Volver)."""
...
class SeleccionarMenuCaja:
    """
    Controlador lógico para las opciones del menú de caja.
    """

    def __init__(self, interfaz_caja_utp, menu_hoy, gestor_reportes):
        """Recibe las dependencias necesarias para ejecutar las acciones de caja."""
        self.interfaz_caja_utp = interfaz_caja_utp
        self.menu_hoy = menu_hoy
        self.gestor_reportes = gestor_reportes
